...
# Q5 Comparison of the FWBscore between the top and bottom third income brackets
...
top3rdincome <- filter(top3rdincome, FWBscore > 0)
...
hist(top3rdincome$FWBscore, col='red', main='Top Third Income Score and Bottom Third Income Score', xlab='Financial Well-being score')
